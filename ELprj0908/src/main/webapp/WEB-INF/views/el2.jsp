...
<body>
	...
	<h3>request</h3>
	<p>하나의 요청이 공유해할 데이터를 저장하는 공간</p>

	<h3>session</h3>
	<p> 사용자 한명이 공유해야 하는 데이터를 저장하는 공간 </p>
	
	<h3>application</h3>
	<p>모든 사용자가 공유해야 하는 데이터를 저장하는 공간 : 설정 정보, 데이터베이스 연결정보 </p>

	<h3>pageContext</h3>
	<p>jsp페이지 하나당 제공되는 저장소</p>
	<p>jsp페이지 내에서 EL사용하여 변수를 처리하고 싶을 때 사용</p>
